...
public class StereotypeDescriptionRegistryConfigurer implements IStereotypeDescriptionRegistryConfigurer {
    ...
    public void addStereotypeDescriptions(IStereotypeDescriptionRegistry registry) {
        ...
        registry.add(new StereotypeDescription("CAL", "CAL!", this::getEmptyCALContent)); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private String getEmptyCALContent() {
        return this.getEmptyContent(CALFactory.eINSTANCE.createComputationApplicationRelease());
    }
