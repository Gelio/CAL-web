...
% Swój podpis należy wyciąć i umieścić w plik gfx/podpis.png
% Najlepiej, gdyby miał przezroczyste tło
% Jeżeli będzie trzeba przesunąć/zmienić rozmiar, zmodyfikuj odpowiednie
% miejsce w EE-dyplom.cls (poszukaj "podpis.png" w tamtym pliku)
