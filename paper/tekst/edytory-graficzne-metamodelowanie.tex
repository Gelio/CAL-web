...
% TODO: (opcjonalnie) opisać hierarchię modeli M0, M1, M2, M3 i wspomnieć o MOF
...
\begin{figure}[!hb]
	...
	\medskip
	% TODO: przenieść ten (i wszystkie inne komentarze obrazków) do tekstu pracy
...
zapisany w pliku \emphgls{XML} w formacie \Ecore{} (rozszerzenie
...
% TODO: dodać bibliografię do AQL
