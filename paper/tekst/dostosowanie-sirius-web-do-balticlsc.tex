...
Z metamodelu \EMF{} języka \CAL{} systemu \BalticLSC{}
...
Chcąc wykorzystać metamodel \EMF{} w \SiriusWeb{} należy wskazać gdzie
...
Aby wykorzystać klasy metamodelu \EMF{} w \SiriusWeb{}
...
jego
zależnościach. Wygenerowane projekty metamodelu \EMF{} to projekty
\Eclipse{}.
...
Kolejno w plikach \texttt{pom.xml} projektów metamodelu \EMF{} należy
...
modele nowo stworzonego metamodelu \EMF{}. Zrzut ekranu z aplikacji
...
metamodelu EMF\@. Były one~uruchamianie w \SiriusDesktop{}. Z uwagi na
fakt, że
...
połączenia metamodelu \EMF{} z \SiriusWeb{}. Zawiera on rozszerzenie
...
testy metamodelu \EMF{} w \Maven{} można uruchomić komendą
...
uruchomienie testów metamodelu za~pomoca \Maven{} trwa dłużej (około
18 sekund), niż
...
\begin{figure}[!hb]
  ...
  \caption{Edytor diagramów \BalticLSC{} po dodaniu modułu obliczeniowego z
...
metamodelu \EMF{} nie pozwalają na komunikację z zewnętrznymi serwisami,
...
zapytanie do serwera \BalticLSC{}, a następnie wyświetlić otrzymane moduły
...
Ponadto, każdy token \emphgls{JWT} posiada podpis weryfikujący jego prawdziwość.
...
\BalticLSC{}, a po najechaniu kursorem wyświetla nazwę modułu oraz jego
...
modelu. Diagram sekwencji komunikatów \WebSocket{} wymienianych między
...
\emph{Java Spring}.
W kodzie obsługi mutacji można wykorzystywać klasy metamodelu \EMF{}.
...
\begin{lstlisting}[float,
    ...
    language=c,
    caption={Mutacja \GraphQL{} dodająca wywołanie modułu obliczeniowego do
      modelu},
...
pliku \texttt{*.odesign} metamodelu \EMF{}), co zostało opisane w
...
z reguł z metamodelu \EMF{}. Błędów tych brakuje w aplikacji
...
\begin{figure}
	...
	\caption{Obsługa reguł walidacji semantycznej \EMF{} w \SiriusWeb{}
...
semantycznej zdefiniowanej w metamodelu \EMF{} zdecydowano, że dodatkowy
...
w metamodelu \EMF{}. Diagram klas systemu walidacji semantycznej widoczny
...
wygenerowana na podstawie metamodelu \EMF{}
...
\emphgls{DOM}~\cite{mdn-dom}. Węzły drzewa odpowiadają elementom \emphgls{HTML} i
za
pomocą różnych method interfejsu \emphgls{API} drzewa \emphgls{DOM} można
otrzymać do
...
możliwa dla subskrypcji \GraphQL{}. Problem został zgłoszny w repozytorium
