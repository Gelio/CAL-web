...
metamodelu.
% TODO: krotność jest informacją składniową. Zmienić, że semantyczna to np.
% znaczenie relacji kompozycji oraz znaczenie rombu odpowiadającego za kompozycję
Przykładową informacją semantyczną w modelu \emphgls{UML} może być
