...
pinów niż powiązany z nim moduł obliczeniowy). W \SiriusDesktop{}
...
\begin{figure}[!ht]
  ...
  \caption{Zablokowana możliwość usunięcia pinu wywołania modułu
...
\begin{figure}[!ht]
  ...
  \caption{Błąd podczas próby usunięcia pinu wywołania modułu obliczeniowego w
