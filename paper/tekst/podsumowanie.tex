...
% TODO: dodać wniosek na temat walidacji modeli (Sirius Web wspiera tylko
% walidację składniową, nie wspiera semantycznej, trzeba było dodać ją samemu, co
% okazało się proste, ponieważ wymagana była jedynie stworzenie nowych klas i
% modyfikacja jednej z istniejących klas kodu Java
