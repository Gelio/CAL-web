...
definicją jego reprezentacji z metamodelu \gls{EMF}, oraz na podstawowe
możliwości
...
edytorów funkcjonujących jako aplikacje natywne, takie jak \emph{Sirius
	Desktop}. Nie wymaga ona procesu instalacji, więc można szybciej
udostępnić
...
i być uwierzytelnieni. \emph{Sirius Web} domyślnie nie narzuca żadnych
...
bezpieczeństwa niemożliwiające dostęp do serwera aplikacyjnego osobom
nieuwierzytelnionym.

Projekt \emph{Sirius Web} jest aktywnie rozwijany. W ciągu miesiąca
...
metamodelu z
wykorzystaniem \emph{Sirius Desktop}, po czym okazało się, że część
