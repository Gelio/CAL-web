...
\begin{itemize}
	...
	\item \texttt{UnitCall} --- wywołania dostępnych modułów
	      ...
	      Na diagramie obiekty te są reprezentowane jako prostokąty ze swoimi portami umieszczonymi na krawędziach. Wewnątrz prostokąta znajduje się etykieta zawierająca nazwę umożliwiającą wyróżnienie tego konkretnego wywołania modułu, oraz nazwę i wersję wydania wywoływanego modułu.
...
\begin{figure}
    ...
    \medskip
    {\small To wywołanie nie~ma~wskazanego modułu, które ma wywołać, stąd
