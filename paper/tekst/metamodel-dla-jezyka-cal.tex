...
pakietów testów (\emph{test suite}), w których można zdefiniować grupy testów,
...
jedynie dwa testy, więc nie było potrzeby dzielić je na grupy (\emph{test
	suites}) --- jest tylko
jedna grupa nadrzędna \emph{CAL All Tests}, która zawiera w sobie grupę
