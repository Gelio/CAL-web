...
\begin{itemize}
	...
	\item \texttt{UnitCall} --- wywołania dostępnych modułów
	      ...
	      Na diagramie obiekty te są reprezentowane jako prostokąty ze swoimi pinami umieszczonymi na krawędziach. Wewnątrz prostokąta znajduje się etykieta zawierająca nazwę umożliwiającą wyróżnienie tego konkretnego wywołania modułu, oraz nazwę i wersję wydania wywoływanego modułu. % TODO: odnieść się do obrazka pokazującego przykładowy diagram
